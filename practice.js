...
favoriteThings.brand = "Don't Care";
...
//Once you get your truthy Object, Change the remaining values in the object to be specific to you (name: 'your name', username: 'your username'), rather than my information.
  ...
  //Code Here
user1.name = "Joseph Lago";
user1.username = "Linkblade";
user1.pwHash = "Password1";
...
*/
  ...
  //Code Here
function bindCard(obj, creditCard) {
  var nameCard = {};
  for(var x in creditCard) {
    try {
      if (creditCard[x].constructor === Object) {
        nameCard[x] = bindCard(obj[x], creditCard[x]);
      } else {
        nameCard[x] = (obj[x] = creditCard[x])
      }
    } catch(e) {
      nameCard[x] = (obj[x] = creditCard[x]);
    }
